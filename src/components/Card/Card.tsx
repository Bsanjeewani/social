...
const Card = () => {
  ...
  return (
    <>
      <div className="relative pt-6 bg-black text-white flex w-full max-w-[26rem] flex-col rounded-xl  bg-clip-border text-gray-700 shadow-lg">
        {/* Auther */}
        ...
        <div className="p-6">
          ...
          {/* <div className="inline-flex flex-wrap items-center gap-3  group">
            <span className="cursor-pointer rounded-full  bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <div className="inline-flex flex-wrap items-center gap-3 group">
            ...
            {showLikes && (
              <div className="mt-2 text-sm text-gray-700">
                <p>Liked by John Doe, Jane Smith, and 118 others</p>
              </div>
            )}
            {showComments && (
              <div className="mt-2 text-sm text-gray-700">
